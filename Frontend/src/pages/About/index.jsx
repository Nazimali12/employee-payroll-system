                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                            ...
                            >
                                <p className="font-medium text-center translate-y-[-60%] sm:translate-y-[-0%] sm:mb-2 md:text-left dark:text-white">
                                    SiPeKa is a system used by companies to manage employee payroll processes efficiently and accurately. This system plays a key role in automating various payroll-related tasks, such as salary calculation, attendance processing, and employee wage payments.
                                </p>
                                <br />
                                <p className="font-medium text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left dark:text-white">
                                   In SiPeKa, employee information such as personal data, job title, and salary level is stored centrally.
                                    Each month, the system retrieves employee attendance data and calculates salaries based on the available information.
